...
public partial class SoundManager : Node, ISkinnable
{
	...
	public static MusicStreamPlayer Song;
	...
	public override void _Ready()
	{
		...
		Lobby.Instance.SpeedChanged += (speed) => { Song.Tempo = (float)speed; };
	...
	public static void PlayJukebox(Map map, bool setRichPresence = true)
	{
		...
		Song.Load($"{MapUtil.MapsCacheFolder}/{map.Name}/audio.{map.AudioExt}");
		Song.Play();
	...
	public static void UpdateVolume()
	{
		...
		Song.Volume = (float)(settings.VolumeMusic + settings.VolumeMaster / 2) / 100;
	...
	{
		bool isSongPlaying = Song != null && Song.IsPlaying;
